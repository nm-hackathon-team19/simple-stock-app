...
const HomeScreen = () => {
  if (!localStorage.getItem('data')) {
    return (
      <div id="home">
        <h1 className="text-center display-4 text-light">Welcome to Fantazy Stocks</h1>
        <div className="home-container">
          <div className="home-content mt-5 h2 font-weight-light">
            <h1 className="display-4 mb-5 home-header">The best choices... begin with practice.</h1>
