    ...
    <div id="home">
      <div className="home-content">
        ...
        <div className="home-buttons-wrapper">
          <button onClick={toggleRegisterModal} className="btn">Sign-up</button>
          <button onClick={toggleLoginModal} className="btn">Log-in</button>
        </div>
      </div>
      <Register show={isModalRegisterShow} toggleModal={toggleRegisterModal} />
